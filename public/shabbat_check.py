...
def main() -> int:
    ...
    # Friday: Shabbat starts at pause_dt, ends Saturday at resume_dt
    # Saturday: Shabbat ends at resume_dt
    # We need to handle Friday evening and Saturday
    ...
    return 0 if not is_shabbat else 2  # 2 = shabbat, agent should pause
